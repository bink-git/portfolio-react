    ...
    >
      ...
      <div className="container max-w-4xl flex flex-col items-center justify-center text-center z-10">
        <MotionDiv animation="fade-in" duration={800}>
          <p className="text-primary font-medium mb-3 text-center text-white">
            Hello, my name is
          </p>
        </MotionDiv>

        <MotionDiv animation="slide-up" delay={300} duration={800}>
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-4 text-center text-white">
            Ivan Bahniuk
          </h1>
        </MotionDiv>

        <MotionDiv animation="slide-up" delay={500} duration={800}>
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mb-8 text-center text-white">
