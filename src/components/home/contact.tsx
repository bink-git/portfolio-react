...
const contactInfo: ContactInfo[] = [
  {
    ...
    title: 'Email',
    details: 'bahniuk.dev@gmail.com',
    href: 'bahniuk.dev@gmail.com',
  },
  {
    icon: <Phone className="h-6 w-6 text-primary" />,
    title: 'Phone',
    details: '+420 721 968 517',
    href: 'tel:+420721968517',
  },
  {
    ...
    <section id="contact" className="section bg-secondary/50">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 items-start">
          <MotionDiv animation="slide-up" className="md:col-span-2 space-y-6">
          ...
          <MotionDiv animation="slide-up" delay={200} className="md:col-span-3">
            <form
